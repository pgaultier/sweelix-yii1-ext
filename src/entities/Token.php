 ...
 * @package   sweelix.yii1.ext.entities
 *
 * @property \sweelix\yii1\ext\entities\Author[]  $authors
 * @property \sweelix\yii1\ext\entities\Content[] $contents
 * @property \sweelix\yii1\ext\entities\Group[]   $groups
...
class Token extends ActiveRecordToken
{
     ...
     *
     * @return \sweelix\yii1\ext\entities\Token the static model class
     * @since  1.0.0
     */
     ...
     *
     * @return \sweelix\yii1\ext\entities\Author or null if not find.
     * @since  3.0.0
     */
    public function getAuthor()
    {
        ...
        if ((isset($this->node->authorId) === true) && ($this->node->authorId !== null)) {
            ...
            if ((isset($this->content->authorId) === true) && ($this->content->authorId !== null)) {
