...
class m121121_080000_initDatabase extends CDbMigration
{
    ...
    public function up()
    {
        ...
        $this->addForeignKey('swauthItemChild_ParentAuthItemFk', '{{swauthItemChild}}', 'parent', '{{swauthItem}}',
            'name', 'CASCADE', 'CASCADE');
        $this->addForeignKey('swauthItemChild_ChildAuthItemFk', '{{swauthItemChild}}', 'child', '{{swauthItem}}',
            'name', 'CASCADE', 'CASCADE');
        $this->addForeignKey('swauthAssignment_ItemAuthItemFk', '{{swauthAssignment}}', 'itemname', '{{swauthItem}}',
            'name', 'CASCADE', 'CASCADE');
