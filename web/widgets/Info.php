...
class Info extends CWidget
{
    ...
    public function run()
    {
        if (defined('YII_DEBUG') && (YII_DEBUG === true)) {
            ...
            foreach ($this->cmsInfo as $info => $value) {
                if ($value !== null) {
                    switch ($info) {
                        case 'sweelix':
                            $infoBlock .= CHtml::tag(
                        ...
                        case 'nodeId':
                            $infoBlock .= CHtml::tag(
                                ...
                                $this->_subOptions,
                                CHtml::link(
                                    Yii::t('sweelix', 'Node {id}', array('{id}' => $value)),
                                    array('sweeft/structure/node/detail', $info => $value),
                                    array('title' => $value, 'style' => 'color:#333')
                                )
                            );
                            break;
                        case 'contentId':
                            $infoBlock .= CHtml::tag(
                                ...
                                $this->_subOptions,
                                CHtml::link(
                                    Yii::t('sweelix', 'Content {id}', array('{id}' => $value)),
                                    array('sweeft/structure/content/detail', $info => $value),
                                    array('title' => $value, 'style' => 'color:#333')
                                )
                            );
                            break;
                        case 'groupId':
                            $infoBlock .= CHtml::tag(
                                ...
                                $this->_subOptions,
                                CHtml::link(
                                    Yii::t('sweelix', 'Group {id}', array('{id}' => $value)),
                                    array('sweeft/cloud/group/detail', $info => $value),
                                    array('title' => $value, 'style' => 'color:#333')
                                )
                            );
                            break;
                        case 'tagId':
                            $infoBlock .= CHtml::tag(
                                ...
                                $this->_subOptions,
                                CHtml::link(
                                    Yii::t('sweelix', 'Tag {id}', array('{id}' => $value)),
                                    array('sweeft/cloud/tag/detail', $info => $value),
                                    array('title' => $value, 'style' => 'color:#333')
                                )
                            );
                            break;
